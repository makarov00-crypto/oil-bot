...
STRATEGY_DOCS: dict[str, dict[str, str]] = {
    "reversal_15m": {
        ...
        "when": "Это основная живая стратегия для unified-группы: валюты, нефть, газ, индексы и банки.",
    },
    "momentum_breakout": {
        ...
        "when": "Сейчас это legacy-стратегия и используется только на оставшихся старых инструментах.",
    },
    "trend_pullback": {
    ...
    "macd_stoch_reversal": {
        ...
        "when": "Историческая стратегия. Для unified-инструментов заменена на `reversal_15m`.",
    },
    "range_break_continuation": {
        ...
        "when": "Историческая стратегия. Для unified-инструментов больше не является основной.",
    },
    "failed_breakout": {
        "title": "Ложный пробой",
    ...
    "opening_range_breakout": {
        ...
        "when": "Историческая стратегия. Для валют unified-группы заменена на `reversal_15m`.",
    },
    "williams": {
  ...
  <main class="wrap">
    <section class="panel hero">
      ...
      <p>
        ...
        для локальной торговли на 15-минутном графике. Старые стратегии ещё остаются только на части legacy-инструментов.
      ...
      <div class="overview-grid">
        <article class="overview-card">
          ...
          <p>
            ...
            Сейчас в unified-контур уже входят валюты, нефть, газ, индекс Мосбиржи, банки и облигационный индекс.
          </p>
        </article>
        <article class="overview-card">
          <h3>Legacy-группа</h3>
          <p>
            Старые стратегии всё ещё живут на отдельных инструментах, которые пока не переведены в unified-контур.
            Для них сохраняются старые фильтры и часть прежней логики принятия решений.
          </p>
        </article>
        <article class="overview-card">
